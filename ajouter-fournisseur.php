<?php
session_start();
include_once("ajouter-fournisseur-action.php");
...
<div class="main-container ">
    ...
    <div class="card col-md-10 pad back-main border-none">
      <div class="col pad flex-column justify-content-between">
        ...
        <form name='form' enctype="multipart/form-data" style="max-width:930px;margin-left:230px;margin-top:px;"class="card"action='ajouter-fournisseur-action.php' method='post'>
        <img style="margin-left:50px;margin-top:2px;max-width:150px;max-height:150px;margin-bottom:3px;" id="img" src="img/fournisseur.png">
         <div class="row g-3">
            <div class="col">
                <input type="text" class=" input-ajout form-control" name="id_fournisseur" placeholder="code_fournisseur" required>
