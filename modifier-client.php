...
include_once("modifier-client-action.php");
...
<div class="main-container ">
    ...
    <div class="card col-md-10 pad back-main border-none">
      <div class="col pad flex-column justify-content-between">
        ...
        <form name='form' enctype="multipart/form-data" style="max-width:930px;margin-left:230px;margin-top:2px;"class="card"action='modifier-client-action.php' method='post'>
        <img style="margin-left:50px;margin-top:2px;max-width:150px;max-height:150px;margin-bottom:2px;" id="img" src="<?=$image;?>">
         <div class="row g-3">
            <div class="col">
                <input type="hidden" class=" input-ajout form-control" name="id_client" value='<?=$id_client;?>' placeholder="code client" required>
     ...
     <select class="form-select" name="ville">
      ...
      <option value="Beja">Sfax</option>
                ...
                <input type="file" class="form-control input-ajout " name="image"   placeholder="image" required>
            </div>
