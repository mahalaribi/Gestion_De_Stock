...
$req2="SELECT cmd.date_création,c.nom,c.prenom,c.tel,c.photo,cmd.id_commande,cmd.etat_commande ,cmd.code_commande from client c join commande_client cmd on c.id_client=cmd.id_client  order by cmd.code_commande DESC limit $start,$rows_per_page";
    ...
    <div class="card col-md-10 pad back-main border-none">
      <div class="col pad flex-column justify-content-between">
        ...
        <div class="card main-height">
                <div><h4 class="lister">Liste des Commandes clients:</h4></div>
            <a href="ajoutercommande-client.php"><div style="margin-left:1100px;" > <button type="button" class="btn btn-primary"><i class="bi bi-plus"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                 <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                 </svg></i>Ajouter</button></div></a>
            <form  style="max-width:1215px;margin-left:55px; margin-top:px;" action="">
        <table class="table">
        <thead>
   
        <tbody>
         <?php 
         $resultat="SELECT * from commande_ligne_client c ";
        ...
        <path d='m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z'/>
          ...
          <div style='margin-top:5px;'>
           ...
           <path d='M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zm9.954 3H2.545c-.3 0-.545.224-.545.5v1c0 .276.244.5.545.5h10.91c.3 0 .545-.224.545-.5v-1c0-.276-.244-.5-.546-.5zm-4.118 9.79c1.258 0 2-1.067 2-2.872 0-1.934-.781-2.668-1.953-2.668-.926 0-1.797.672-1.797 1.809 0 1.16.824 1.77 1.676 1.77.746 0 1.23-.376 1.383-.79h.027c-.004 1.316-.461 2.164-1.305 2.164-.664 0-1.008-.45-1.05-.82h-.684c.047.64.594 1.406 1.703 1.406zm-2.89-5.435h-.633A12.6 12.6 0 0 0 4.5 8.16v.695c.375-.257.969-.62 1.258-.777h.012v4.61h.675V7.354z'/>
            ...
            <div style='margin-top:5px;'>
            <i  style='color:green;' class='bi bi-cart4'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-cart4' viewBox='0 0 16 16'>
            <path d='M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z'/>
           </svg></i>En cours
           </div>
           <div style='margin-top:5px;'>
           <i style='color:red; class='bi bi-dash-square'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-dash-square' viewBox='0 0 16 16'>
           ...
           <path d='M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z'/>
            ...
            <a href='modifier-commande-client.php?code_commandem=$row[code_commande]'><img class='photo-action' src='img/update.png'></a>
            <a href='supprimer-commande-client.php?code_ommande=$row[code_commande]'><img class='photo-action' src='img/delete.jfif'></a>
      ...
      <?php
     $resultat="SELECT * from commande_ligne_client c join article a on a.id_article=c.id_article order by id_lignec desc  ";
     $res2= $conx->query($resultat);
      if(!$res2)
       {
        die("invalide requete!");
