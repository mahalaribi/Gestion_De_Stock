...
include_once("ajouter-article-action.php");
    ...
    <title>Document</title>
	  <link rel="stylesheet" href="bootstrap/css/bootstrap.css">
       ...
       <link rel="stylesheet" href="style_main.css">
        ...
        function changer()
        {
            val1=parseInt(document.getElementById('file').value); 
        }
        </script>
       <style>
    ...
    <div class="card col-md-10 pad back-main border-none">
      <div class="col pad flex-column justify-content-between">
        ...
        <div><h4 class="lister"><i class="bi bi-info-lg"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-info-lg" viewBox="0 0 16 16">
            ...
            </svg>Information article:</i></h4></div>
        <form name='form' enctype="multipart/form-data" style="max-width:930px;margin-left:230px;margin-top:5px;"class="card"action='ajouter-article-action.php' method='post'>
        <img style="margin-left:50px;margin-top:10px;max-width:150px;max-height:150px;margin-bottom:5px;" id="img" src="img/article.png">
         <div class="row g-3">
            <div class="col">
                <input type="text" class=" input-ajout form-control" name="id_article" placeholder="code_article" required>
                <input type="text" class="input-ajout form-control" name="TVA" id="TVA" onchange="recalculer();" placeholder="TVA"  required>
                <input type="text" class="input-ajout form-control" name="HT"id="HT" onchange="recalculer();" placeholder="HT" required>
                <div class="mb-3"><input  class="input-ajout form-control filee" type="file" name="image"></div>
            </div>
            <div class="col">
               <input type="text" class="form-control input-ajout " name="TTC" readonly="readonly"  id="TTC" placeholder="TTC" required>
                <input type="text" class="form-control input-ajout " name="designation"  placeholder="designation" required>
                <div class="col-auto">
                   <select class="input-ajout form-select" name="code_categ" placeholder="code_categorie" id="autoSizingSelect">
                    <option placeholder="choisir catégorie"selected> choisir catégorie</option>
                    <?php 
