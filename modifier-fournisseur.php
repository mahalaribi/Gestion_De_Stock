<?php
session_start();
include_once("modifier-fournisseur-action.php");
    ...
    <div class="card col-md-10 pad back-main border-none">
      <div class="col pad flex-column justify-content-between">
        ...
        <div><h4 class="lister"><i class="bi bi-info-lg"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-info-lg" viewBox="0 0 16 16">
            ...
            </svg>Information fournisseur:</i></h4></div>
        <form name='form' enctype="multipart/form-data" style="max-width:930px;margin-left:230px;margin-top:2px;"class="card"action='modifier-fournisseur-action.php' method='post'>
        <img style="margin-left:50px;margin-top:2px;max-width:150px;max-height:150px;margin-bottom:2px;" id="img" src="<?=$image;?>">
         <div class="row g-3">
            <div class="col">
                <input type="hidden" class=" input-ajout form-control" name="id_fournisseur" value='<?=$id_fournisseur;?>' placeholder="code fournisseur" required>
                <input type="text" class="input-ajout form-control" name="nom" id="nom" value='<?=$nom;?>' placeholder="Nom"  required>
                <input type="text" class="input-ajout form-control" name="prenom"id="prenom"  value='<?=$prenom;?>'placeholder="Prenom" required>
                ...
                <input type="file" class="form-control input-ajout " name="image"  value='' placeholder="image" required>
            </div>
            <div class="col">
               <input type="email" class="form-control input-ajout " name="mail" value='<?=$mail;?>'   id="Email" placeholder="Email" required>
                <input type="text" class="form-control input-ajout " name="tel" value='<?=$tel;?>' placeholder="+216" required>
                <input type="text" class="form-control input-ajout " name="code_postale" value='<?=$code_postale;?>' placeholder="Code_postale" required>
                <input type="text" class="form-control input-ajout " name="pays" value='<?=$pays;?>' placeholder="Pays" required>
