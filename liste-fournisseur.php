...
if(isset($_GET['pagenr3']))
{
  $page = $_GET['pagenr3'] - 1;
  $start=$page*$rows_per_page;
}
$req2="SELECT * from fournisseur limit $start,$rows_per_page";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container ">
    ...
    <div class="card col-md-10 pad back-main border-none">
      <div class="col pad flex-column justify-content-between">
        ...
        <div class="card main-height ">
            <div><h4 class="lister">Liste des fournisseurs:</h4></div>
        <table class="table caption-top">
        <caption><a href="ajouter-fournisseur.php"><img class="image-ajouter" src="img/ajouter.png"/></a></caption>
        <thead>
    <tr>
    ...
    <tbody>
       ...
       <td><img style='max-width:20px;max-height:15px;'src='img/information.png'> $row[id_fournisseur]<br><img style='max-width:20px;max-height:15px;'src='img/information.png'>$row[prenom]<br><img style='max-width:20px;max-height:15px;'src='img/information.png'> $row[nom]</td>
      <td><img style='max-width:30px;max-height:30px;'src='img/tel.jpg'> $row[num]<br><img style='max-width:20px;max-height:20px;'src='img/mail.png'> $row[mail]</td>
      ...
      <td>
          <br> 
         <a href='modifier-fournisseur.php?code_f=$row[id_fournisseur]'><img class='photo-action' src='img/update.png'></a>
         <a href='supprimer-fournisseur.php?code_f=$row[id_fournisseur]'><img class='photo-action' src='img/delete.jfif'></a>
  ...
  <li class="page-item"><a class="page-link" href="?pagenr3=1">first</a></li>
  <?php 
  if(isset($_GET['pagenr3']) && $_GET['pagenr3'] > 1)
  {
  ?>
  <li class="page-item"><a class="page-link" href="?pagenr3=<?php echo $_GET['pagenr3'] -1 ?>">Previous</a>
</li>
  <?php
    } 
   else{ 
   ...
   <?php
     ...
     ?>
    <li class="page-item"><a class="page-link" href="?pagenr3=<?php echo $counter?>"><?php echo $counter?></a></li>
   <?php
   }?>
  ...
  if(!isset($_GET['pagenr3']) ){
  ?>
  <li class="page-item"><a class="page-link" href="?pagenr3=2">Next</a></li>
  <?php }else{
    if($_GET['pagenr3']>= $pages) {
      ?>
     <li class="page-item"><a class="page-link" href="">Next</a></li>
      <?php 
    }else{?>
        <li class="page-item"><a class="page-link" href="?pagenr3=<?php echo $_GET['pagenr3'] + 1 ?>">Next</a></li>
      <?php
      }
  }
  ?>

    <li class="page-item"><a class="page-link" href="?pagenr3=<?php echo $pages?>">last</a></li>
