...
<head>
    ...
    <title>Document</title>
	  <link rel="stylesheet" href="bootstrap/css/bootstrap.css">
       ...
       <script src="commandefournisseur.js"></script>
       <style>
        .image-ajouter{
            max-width:40px;
            max-height:40px;
...
<div class="main-container ">
    ...
    <form name='form' method="POST" enctype="multipart/form-data" action="commande-action-fournisseur.php">
    <!-- code ccommand -->
    ...
    <div class="col " style="border-right:solid; border-color:grey; margin-left:30px;max-width:350px">
       <input type="text" class="cod-commande form-control"name="code_commandef" placeholder="code-commande" aria-label="First name">
      <input type="date"  class="form-control cod-commande" name="date" value="<?=$date_creation;?>"aria-label="First name" readonly="readonly">
      <select  id="mySelect" name="code_fournisseur"  class="form-select cod-commande">
      <option value="value" disabled="" selected="">code fournisseur...</option>
      <?php 
